...
The Quran's most drastic sentiments are in the beginning. As the Quran progresses, it stays fairly centered at a net sentiment score of 0 and the variation in sentiment score gradually becomes smaller and smaller. 

In comparison to the Quran, the KJV Bible has much more drastic sentiment scores, with the most extreme scores of the KJV Bible nearly three times as large as the most extreme sentiment scores in the Quran. Interestingly, the trajectory of the Bible seems to correspond with differences in sentiment based on the deliniation of Old vs. New Testament: the Old Testament of the KJV is constitutes books one through 39, and this is where we see very drastic variety in sentiment; the New Testament, constituting books 39 through 66 are distinctly positive in nature.

Overall, the Quran's net surah sentiment appears to be very consistent and neutral throughout, while the KJV Bible's net chapter sentiment appears to begin drastically up and down, and end on a definitely positive note. 
