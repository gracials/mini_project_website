...
The Boston Marathon data only presents a few key measurements. While these are crucial for understanding the shifting numbers of the Boston Marathon, future analysis should consider including data that can touch more thoroughly on some other points of measurement, such as data disaggregated by age or race as means for pursing a more intersectional analysis of gender equality in race participation.
